...
#replaced lines 5 - 10 with corresponding lines from PyPoll.py to load csv
...
largest_county_turnout_votecount = 0
largest_county_turnout_percentage = 0

# Read the csv and convert it into a list of dictionaries (replaced starter with corresponding code from PyPoll)
...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_dict:
        ...
        if (county_votes > largest_county_turnout_votecount) and (county_vote_percentage > largest_county_turnout_percentage):
            largest_county_turnout_votecount = county_votes
    ...
    largest_county_summary = (
        ...
        f"Largest County Vote Count: {largest_county_turnout_votecount:,}\n"
        f"-------------------------\n")
